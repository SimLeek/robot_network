...
class AudioBuffer:
    """Buffer class to handle packing and unpacking FLAC-compressed audio data."""

    type_list = [List[npt.NDArray[np.float32]], int]  # np.ndarray to store audio data

    def __init__(self, audio_data: List[npt.NDArray[np.float32]] = None, sample_rate: int = 44100):
