...
- [complete] AI process lifecycle handling: slow startup and safe shutdown, since spinning up/down can take a while
...
- [complete] brain->AI signal: is the brain running as expected (framerate + last-update timestamp)
